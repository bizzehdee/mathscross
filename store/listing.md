...
80 characters maximum. Currently 62.

```
Offline maths crosswords. No adverts, no accounts, no internet.
```

The three things that actually distinguish it, in the order they matter. "Offline"
first because it is the promise the app can prove — it requests no internet
permission at all.
...
• Three difficulties. Easy is a 5x5 with single digits, plus and minus. Medium is a
  7x7 with two-digit numbers and some operators hidden. Hard is a 9x9 with
  three-digit numbers, division, and every single operator hidden.
...
| Phone screenshots | 1080 x 1920, at least 4 | captured, see `README.md` |
| 7-inch tablet | 1920 x 1080 | captured |
| 10-inch tablet | 2560 x 1440 | captured |
...
- No families or Designed for Families declaration — the audience is general adult
  players. The Kids tier is deferred to release 2, and if it arrives this decision
  and the content rating both need revisiting.
